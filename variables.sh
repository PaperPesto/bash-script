...
echo "VAR1 is $VAR1"
echo "VAR2 is $VAR2"
echo "You can see that exists one only copy of VAR1 and VAR2, and these are shared between main shell and function subshell unless you declare it local inside the function."
